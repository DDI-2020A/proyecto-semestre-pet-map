                    ...
                    <Row>
                        <Col span={15} offset={5} gutter={{xs: 8, sm: 16, md: 24, lg: 32}}>
                            <div>
                                ...
                                <p className='paragraph'>Si deseas colaborar por medio de donaciones de insumo, productos y
                                    servicios,
                                ...
                                <p className='paragraph'>Las principal necesidad que tenemos en PET MAP es alimento balanceado para
                                    los animales que necesitamos por lo cual que te solicitamos que sea esta la primera aportación
                                    que realices
                                    en favor de nuestras actividades</p>
                                <p className='paragraph'>PET MAP requiere de más de una tonelada mensual de alimento, si te decides
                                    para ayudarnos con esto, toma en cuenta
                                    que es mejor que nos dones alimentos para cachorros, ya que este sirve para alimentar a los
                                    animales de toda edad y
                                    condición.</p>
                                ...
                                <p className='paragraph'>Por favor comunícate con nuestra clínica, para que puedas conocer las
                                    presentaciones que utilizamos en nuestros procesos.</p>
                                <p className='paragraph'>
                                    <ul>
                                ...
                                <Link to={Routes.DONACIONESTRANSFERENCIA}><Button type="primary" className='buttonopt'>Donaciones
                                    Transferencia bancaria</Button></Link>
                                <Link to={Routes.DONACIONESDEBITO}><Button type="primary" className='buttonopt'>Donaciones Débito
                                    Bancario</Button></Link>
                            </div>
                        </Col>
                    </Row>
                </div>
